    ...
    const handleJsonPopulate = () => {
        try {
            ...
            setFormData(prev => ({
                ...
                author: parsedData.author || 'Dr. Mayur Kumar Goyal',
                // Handle tags: if array, join with commas; if string, keep as is
        ...
        <div className="max-w-4xl mx-auto pb-10">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                    ...
                    <h1 className="text-2xl font-bold text-slate-900">Add New Blog Post</h1>
                </div>
                <button
